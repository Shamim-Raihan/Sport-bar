                                                              ...
                                                              children: [
                                                                Text(
                                                                  _tournamentController
                                                                          ...
                                                                          null
                                                                      ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.baseballSportDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                              1000)
                                                                          .toString()
                                                                          .substring(
                                                                              0,
                                      ...
                                      () => ListView.builder(
                                        physics: BouncingScrollPhysics(
                                            parent:
                                                AlwaysScrollableScrollPhysics()),
                                        itemCount: _tournamentController
                                            .baseballSportNextDataList.length,
                                        itemBuilder: (context, index) {
                                          return Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: GestureDetector(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  _tournamentController
                                                                              ...
                                                                              .currentPeriodStartTimestamp !=
                                                                          null
                                                                      ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.baseballSportNextDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                              1000)
                                                                          .toString()
                                                                          .substring(
                                                                              0,
                                                            ...
                                                            children: [
                                                              Text(
                                                                _tournamentController
                                                                            ...
                                                                            .currentPeriodStartTimestamp !=
                                                                        null
                                                                    ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.basketballSportDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                            1000)
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                    ...
                                    () => ListView.builder(
                                      physics: BouncingScrollPhysics(
                                          parent:
                                              AlwaysScrollableScrollPhysics()),
                                      itemCount: _tournamentController
                                          .basketballSportNextDataList.length,
                                      itemBuilder: (context, index) {
                                        return Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: GestureDetector(
                                                            ...
                                                            children: [
                                                              Text(
                                                                _tournamentController
                                                                            ...
                                                                            .currentPeriodStartTimestamp !=
                                                                        null
                                                                    ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.basketballSportNextDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                            1000)
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                            ...
                                                            children: [
                                                              Text(
                                                                _tournamentController
                                                                            ...
                                                                            .currentPeriodStartTimestamp !=
                                                                        null
                                                                    ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.rugbySportDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                            1000)
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                            ...
                                                            children: [
                                                              Text(
                                                                _tournamentController
                                                                            ...
                                                                            .currentPeriodStartTimestamp !=
                                                                        null
                                                                    ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.rugbySportNextDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                            1000)
                                                                        .toString()
                                                                        .substring(
                                                                            0,
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                _tournamentController
                                                                            ...
                                                                            .currentPeriodStartTimestamp !=
                                                                        null
                                                                    ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.americanSportDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                            1000)
                                                                        .toString()
                                                                        .substring(
                                                                            11,
                                    ...
                                    () => ListView.builder(
                                      physics: BouncingScrollPhysics(
                                          parent:
                                              AlwaysScrollableScrollPhysics()),
                                      itemCount: _tournamentController
                                          .americanSportNextDataList.length,
                                      itemBuilder: (context, index) {
                                        return Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: GestureDetector(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                _tournamentController
                                                                            ...
                                                                            .currentPeriodStartTimestamp !=
                                                                        null
                                                                    ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.americanSportNextDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                            1000)
                                                                        .toString()
                                                                        .substring(
                                                                            11,
