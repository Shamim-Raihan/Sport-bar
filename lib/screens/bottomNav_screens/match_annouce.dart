...
class _MatchAnnounceScreenState extends State<MatchAnnounceScreen> {
  ...
  void updateSearchQuery2(String query) {
    searchQuery2.value = query;
  }
                    ...
                    child: TabBarView(
                      children: [
                                          ...
                                          child: Obx(
                                            () => ListView.builder(
                                              ...
                                              itemCount: _tournamentController
                                                  .baseballSportDataList.length,
                                              itemBuilder: (context, index) {
                                                final item = _tournamentController
                                                        .baseballSportDataList[
                                                    index];
                                                final searchMatches = item
                                                        .homeTeam!.name!
                                                        .toLowerCase()
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        _tournamentController.baseballSportDataList[index].time!.currentPeriodStartTimestamp !=
                                                                                null
                                                                            ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.baseballSportDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(0,
                                                                                11)
                                                                            : 'N/A',
                                                                        style: TextStyle(
                                                                            letterSpacing:
                                                                      ...
                                                                      Text(
                                                                        _tournamentController.baseballSportDataList[index].time!.currentPeriodStartTimestamp !=
                                                                                null
                                                                            ? _tournamentController.readTimestamp(_tournamentController.baseballSportDataList[index].time!.currentPeriodStartTimestamp!)
                                                                            : 'N/A',
                                                                        style: TextStyle(
                                                                            letterSpacing:
                                                                                0.5,
                        ...
                        _tournamentController.dataloading.value
                            ...
                            : _tournamentController
                                    .baseballSportNextDataList.isEmpty
                                ? Container()
                                : SingleChildScrollView(
                                    child: Column(
                                      children: [
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        _tournamentController.baseballSportNextDataList[index].time!.currentPeriodStartTimestamp !=
                                                                                null
                                                                            ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.baseballSportNextDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(0,
                                                                                11)
                                                                            : 'N/A',
                                                                        style: TextStyle(
                                                                            letterSpacing:
                                                                      ...
                                                                      Text(
                                                                        _tournamentController.baseballSportNextDataList[index].time!.currentPeriodStartTimestamp !=
                                                                                null
                                                                            ? _tournamentController.readTimestamp(_tournamentController.baseballSportNextDataList[index].time!.currentPeriodStartTimestamp!)
                                                                            : 'N/A',
                                                                        style: TextStyle(
                                                                            letterSpacing:
                                                                                0.5,
                  ...
                  child: TabBarView(
                    children: [
                                          ...
                                          () => ListView.builder(
                                            physics: BouncingScrollPhysics(
                                                parent:
                                                    AlwaysScrollableScrollPhysics()),
                                            itemCount: _tournamentController
                                                .basketballSportDataList.length,
                                            itemBuilder: (context, index) {
                                              final item = _tournamentController
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      _tournamentController.basketballSportDataList[index].time!.currentPeriodStartTimestamp !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.basketballSportDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(
                                                                              0,
                                                                              11)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                                    ...
                                                                    Text(
                                                                      _tournamentController.basketballSportDataList[index].time!.currentPeriodStartTimestamp !=
                                                                              null
                                                                          ? _tournamentController.readTimestamp(_tournamentController
                      ...
                      _tournamentController.dataloading.value
                          ...
                          : _tournamentController
                                  .basketballSportNextDataList.isEmpty
                              ? Container()
                              : SingleChildScrollView(
                                  child: Column(
                                    children: [
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      _tournamentController.basketballSportNextDataList[index].time!.currentPeriodStartTimestamp !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.basketballSportNextDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(
                                                                              0,
                                                                              11)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      _tournamentController.rugbySportDataList[index].time!.currentPeriodStartTimestamp !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.rugbySportDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(
                                                                              0,
                                                                              11)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      _tournamentController.rugbySportNextDataList[index].time!.currentPeriodStartTimestamp !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.rugbySportNextDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(
                                                                              0,
                                                                              11)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      _tournamentController.americanSportDataList[index].time!.currentPeriodStartTimestamp !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.americanSportDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(
                                                                              11,
                                                                              16)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      _tournamentController.americanSportNextDataList[index].time!.currentPeriodStartTimestamp !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.americanSportNextDataList[index].time!.currentPeriodStartTimestamp!) * 1000).toString().substring(
                                                                              11,
                                                                              16)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    Text(
                                                                      _tournamentController.tournamentList[index]['time']['currentPeriodStartTimestamp'] !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.tournamentList[index]['time']['currentPeriodStartTimestamp']) * 1000).toString().substring(
                                                                              0,
                                                                              11)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                                    ...
                                                                    Text(
                                                                      _tournamentController
                                                                              .tournamentList[index][
                                                                                  'time']
                                                                              .isNotEmpty
                                                                          ? _tournamentController.readTimestamp(_tournamentController.tournamentList[index]['time']
                                                                              [
                                                                              'currentPeriodStartTimestamp'])
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                      ...
                                      child: SingleChildScrollView(
                                        ...
                                        child: SizedBox(
                                          child: ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            itemCount: _tournamentController
                                                .tournamentList2.length,
                                            itemBuilder: (context, index) {
                                              // // Filter the list based on the search query
                                              final item = _tournamentController
                                                  .tournamentList2[index];
                                              final searchMatches = item[
                                                          'homeTeam']['name']
                                                      .toLowerCase()
                                                      .contains(searchQuery2
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    Text(
                                                                      _tournamentController.tournamentList2[index]['time']['currentPeriodStartTimestamp'] !=
                                                                              null
                                                                          ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.tournamentList2[index]['time']['currentPeriodStartTimestamp']) * 1000).toString().substring(
                                                                              0,
                                                                              11)
                                                                          : 'N/A',
                                                                      style: TextStyle(
                                                                    ...
                                                                    Text(
                                                                      _tournamentController
                                                                              .tournamentList2[index][
                                                                                  'time']
                                                                              .isNotEmpty
                                                                          ? _tournamentController.readTimestamp(_tournamentController.tournamentList2[index]['time']
                                                                              [
                                                                              'currentPeriodStartTimestamp'])
                                                                          : 'N/A',
                                                                      style: TextStyle(
                ...
                child: TabBarView(
                  children: [
                    _tournamentController.dataloading.value
                        ...
                        : _tournamentController
                                .SelectedFootballSportDataList.isEmpty
                            ? Container()
                            : SingleChildScrollView(
                                child: Column(
                                  children: [
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    _tournamentController
                                                                                ...
                                                                                .currentPeriodStartTimestamp !=
                                                                            null
                                                                        ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.SelectedFootballSportDataList[index].time!.currentPeriodStartTimestamp!) *
                                                                                1000)
                                                                            .toString()
                                                                            .substring(
                                                                                0,
                    ...
                    _tournamentController.dataloading.value
                        ...
                        : _tournamentController
                                .SelectedFootballSportDataList2.isEmpty
                            ? Container()
                            : SingleChildScrollView(
                                child: Column(
                                  children: [
                                      ...
                                      child: Obx(
                                        () => ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            // Filter the list based on the search query
                                            final item = _tournamentController
                                                .SelectedFootballSportDataList2[index];
                                            final searchMatches = item
                                                .homeTeam!.name!
                                                .toLowerCase()
                                                .contains(searchQuery2
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    _tournamentController
                                                                                ...
                                                                                .currentPeriodStartTimestamp !=
                                                                            null
                                                                        ? DateTime.fromMillisecondsSinceEpoch((_tournamentController.SelectedFootballSportDataList2[index].time!.currentPeriodStartTimestamp!) *
                                                                                1000)
                                                                            .toString()
                                                                            .substring(
                                                                                0,
